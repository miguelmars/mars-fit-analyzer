...
STRAVA_ALLOWED_ATHLETE_ID: Optional[int] = (
...
# Lista completa de streams disponibles en la API de Strava v3.
# Referencia: https://developers.strava.com/docs/reference/#api-Streams-getActivityStreams
# - time           : segundos desde el inicio (siempre presente)
# - distance       : distancia acumulada en metros
# - latlng         : coordenadas GPS [lat, lng]
# - altitude       : elevación en metros
# - velocity_smooth: velocidad suavizada en m/s
# - heartrate      : FC latido a latido en bpm
# - cadence        : cadencia en rpm (ciclismo) o pasos/min (running)
# - watts          : potencia en vatios (requiere potenciómetro o estimación)
# - temp           : temperatura ambiente en °C (requiere sensor)
# - moving         : booleano — ¿el atleta se movió en ese segundo?
# - grade_smooth   : gradiente suavizado en %
STRAVA_STREAM_KEYS = [
