...
CREATE POLICY IF NOT EXISTS "service_full_access" ON strava_tokens
    FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "service_full_access" ON strava_activities_raw
    FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "service_full_access" ON strava_streams_raw
    FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "service_full_access" ON strava_laps_raw
    FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "service_full_access" ON strava_sync_state
    FOR ALL USING (true) WITH CHECK (true);
