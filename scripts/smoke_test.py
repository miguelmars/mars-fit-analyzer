...
# Bloque A: si EPOCH_API_KEY está configurada, los POST del smoke la mandan
_KEY = os.environ.get("EPOCH_API_KEY", "")
...
CHECKS = [
    ...
    # UI v2 Sprint 1: calidad de lectura (Lab vs Field)
    ("/gpt/session/strava_18758175501/streams-summary", "reading_quality"),
    # UI v2 Sprint 3: body map
    ("/gpt/body-map", "zones"),
    ("/plan", "static/app.js"),
