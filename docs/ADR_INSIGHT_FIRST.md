...
**Fuente:** Epoch Brand Foundation v3.0, Product Philosophy, "epoch vision informacio", **Epoch_UI_Guide_v1.pdf (canónico para UI: 9 pilares, componentes, lenguaje, checklist)**
