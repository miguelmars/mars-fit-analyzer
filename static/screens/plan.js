...
async function loadPlan(){
  const el=$('plan-data');
  try{
    const [tp,tc,erg,reb,proj,align]=(await Promise.allSettled([
    ...
    el.innerHTML=insight+rebCard+ring+gapCard+projCard+phasesCard+weekCard+alignCard+calCard+compCard;
