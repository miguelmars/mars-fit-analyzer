async function loadHome(){
  try{
    ...
    const d=_hv(0,{}),w=_hv(1,{}),mp=_hv(2,{}),wh=_hv(3,{}),wr=_hv(4,[]),bf=_hv(5,{}),lastAct=_hv(6,{}),ac=_hv(7,{}),rw=_hv(8,{}),tc=_hv(9,{}),ta=_hv(10,{}),topt=_hv(11,{});
      ...
      const rows=topt.options.map(function(o){
        ...
        return '<div style="border:'+border+';background:'+bg+';border-radius:12px;padding:10px 12px;margin-bottom:6px">'+
          '<div style="display:flex;justify-content:space-between;align-items:center;gap:8px">'+
            '<div style="font-size:13px;font-weight:800">'+o.title+(o.recommended?' <span class="chip ok" style="margin-left:4px">suggested</span>':'')+'</div>'+
