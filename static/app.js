  ...
  try{
    ...
    function historyView(){
      ...
      const rows=years.map(function(y){
        ...
        const sub=preliminary?'preliminary · maturity '+Number(y.maturity||0).toFixed(0)+'%':sport+' · '+(y.active_weeks||0)+' semanas';
    ...
    el.innerHTML=
      ...
      (function(){
        ...
        return '<div class="card" style="border-left:3px solid #3dd68c"><div class="head"><h3>What your month built</h3><span>last 4 weeks · with evidence</span></div>'+rows+
          '<div style="font-size:10px;color:var(--muted);margin-top:6px">Cada capacidad cita las sesiones que la construyeron.</div></div>';
      })()+
      ...
      evd('Historia por capacidad · bloques de 12 semanas',historyView()+climbingHistoryView()+bodyCompositionHistoryView())+
