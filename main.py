...
# MARS_ZONES se importa desde mars_context.py (línea 532)
...
from db import DATABASE_URL, db_conn, get_db, _init_db, _ensure_gear_service_table, _ensure_nutrition_table
