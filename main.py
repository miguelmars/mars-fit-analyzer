...
app = FastAPI(title="Epoch API — Mars Edition", version="6.0")
...
async def _start_auto_stream_backfill():
    """Lanza el auto-backfill de streams en background al startup."""
...
@app.get("/api")
def api_status():
    return {"status":"ok","service":"Epoch API — Mars Edition","version":"6.0",
