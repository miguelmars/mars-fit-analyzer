...
class PostSessionIn(BaseModel):
    ...
    gel_carbs_g: Optional[int] = None
    gel_sodium_mg: Optional[int] = None
...
class WellnessIn(BaseModel):
    date: str
    category: str  # compex_recovery, massage_gun, ceragem, foam_roller, stretching, sleep, pain, stress, illness
    # Compex Recovery
    compex_program: Optional[str] = None   # active_recovery, recovery, massage
    # Massage gun / foam roller
    muscle_zone: Optional[List[str]] = None
    duration_min: Optional[int] = None
    # Ceragem
    ceragem_duration_min: Optional[int] = None
    ceragem_sensation_before: Optional[int] = None  # 1-10
    ceragem_sensation_after: Optional[int] = None   # 1-10
    # Sueño
    sleep_hours: Optional[float] = None
    sleep_quality: Optional[str] = None   # bueno, regular, malo
    hr_rest: Optional[int] = None
    ...
    pain_type: Optional[str] = None       # muscular, articular, tendon, overuse
    # Estrés
    stress_level: Optional[int] = None    # 1-10
    stress_cause: Optional[str] = None    # work, travel, illness, personal, fatigue
    # General
    notes: Optional[str] = None
...
class FuerzaIn(BaseModel):
    date: str
    category: str        # compex, plyo, gym, core, bands, functional
    subcategory: Optional[str] = None  # strength, explosive, resistance, endurance (para compex)
    muscle_groups: Optional[List[str]] = None  # quadriceps, hamstrings, glutes, calves, shoulders, core, back
    intensity: Optional[int] = None      # para Compex: 1-100
    duration_min: Optional[int] = None
    sets: Optional[int] = None           # para gym/plyo
    reps: Optional[int] = None
    weight_kg: Optional[float] = None
    exercise: Optional[str] = None       # nombre del ejercicio (gym/plyo)
    notes: Optional[str] = None
    rpe: Optional[int] = None            # esfuerzo percibido 1-10
    fatigue_before: Optional[int] = None # fatiga pre-sesión 1-10
