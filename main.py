...
import tempfile, os, zipfile, math, statistics, uuid, json, base64
...
def save_records_db(conn, session_id, records):
    ...
    try:
        ...
        print(f"Records saved: {len(rows)} rows for {session_id}")
    except Exception as e:
        print(f"save_records_db error: {e}")
...
# ═══════════════════════════════════════════════════════════════════════════════
# PWA — Bitácora instalada como app en iPhone/Android
# ═══════════════════════════════════════════════════════════════════════════════

ICON_192_PNG_B64 = """"""
ICON_512_PNG_B64 = """"""
...
def pwa_manifest():
    ...
    return JSONResponse({
        "name": "Bitácora Mars",
        "short_name": "Bitácora",
        "description": "Sistema de análisis de entrenamiento ciclista de Mars",
        "start_url": "/home",
        "scope": "/",
        "display": "standalone",
        ...
        "shortcuts": [
            {"name": "Subir FIT", "short_name": "Subir", "url": "/", "description": "Subir archivo Garmin ZIP/FIT"},
            {"name": "Actividades", "short_name": "Actividades", "url": "/activities", "description": "Ver sesiones"},
            {"name": "Fuerza", "short_name": "Fuerza", "url": "/fuerza", "description": "Registrar fuerza"},
            {"name": "Wellness", "short_name": "Wellness", "url": "/wellness", "description": "Registrar recuperación"}
        ]
    })
...
def service_worker():
    ...
    sw_code = """const CACHE = 'bitacora-mars-v1';
const CORE = ['/home','/','/activities','/dashboard','/progress','/calendar','/performance','/gear','/fuerza','/wellness','/manifest.json','/icon-192.png','/icon-512.png'];
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.startsWith('/analyze-fit') || url.pathname.startsWith('/admin/') || url.pathname.startsWith('/gpt/')) return;
...
def icon_192():
    from fastapi.responses import Response
    return Response(content=base64.b64decode(ICON_192_PNG_B64), media_type="image/png")


@app.get("/icon-512.png")
def icon_512():
    from fastapi.responses import Response
    return Response(content=base64.b64decode(ICON_512_PNG_B64), media_type="image/png")
...
def gpt_cadence_trend(weeks: int = 8, sport: str = "cycling"):
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute("""
                SELECT ROUND(AVG(CASE WHEN cadence > 85 THEN 1.0 ELSE 0.0 END)*100,1) as pct_sobre_85,
                       ROUND(AVG(CASE WHEN cadence > 95 THEN 1.0 ELSE 0.0 END)*100,1) as pct_sobre_95,
...
def gpt_fueling_log(limit: int = 20):
    """Historial de nutrición post-sesión — geles, barras, agua, cafeína, CHO/hora estimado."""
    conn = get_db()
    if not conn:
        raise HTTPException(503, "DB no disponible")
    try:
        ...
        for r in rows:
            ...
            cho = (rd.get("gels") or 0)*25 + (rd.get("bars") or 0)*40
            rd["cho_g"] = cho
