...
<body>
<div class="app">
  <div class="top"><div class="brand"><div class="logo">M</div><div><small id="kicker">Bitácora Mars</small><strong id="title">Home</strong></div></div><button class="icon" id="backBtn" onclick="appBack()" aria-label="Volver">↩</button></div>
  <main class="content">
...
function updateBack(){const b=$('backBtn');if(b)b.title=current==='home'?'Volver':'Regresar'}
